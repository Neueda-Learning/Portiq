...
This epic focuses on ensuring that only authenticated users can access portfolio information while keeping sensitive financial data secure.

### US-01: Secure Login to Access Portfolio

#### User Story

> As an investor, I want to securely log into Portiq so that only I can access my portfolio and financial information.

#### Background

Investment portfolios contain sensitive financial information, including investment amounts, purchase prices, and portfolio performance. Protecting this information was one of the first priorities during development. Rather than relying on a simple login mechanism, the authentication process was designed using industry-standard security practices to ensure only authorized users can access the application.
...
### US-02: Support Biometric Authentication

#### User Story

> As an investor, I want to use biometric authentication so that I can access my portfolio securely without always entering my password.

#### Background

While passwords provide security, frequent logins can reduce convenience for users. To improve both security and user experience, Portiq supports biometric authentication using the WebAuthn standard, allowing compatible devices to authenticate users through fingerprint or facial recognition.
...
### US-07: Track Historical Portfolio Performance

#### User Story

> As an investor, I want to review my portfolio's historical performance so that I can understand how my investments have changed over time and identify long-term trends.

#### Background

Investors often make decisions based on long-term performance rather than daily fluctuations. To support this, Portiq maintains historical portfolio values, allowing users to visualize growth trends and compare portfolio performance across different periods.

Historical data also provides useful context when evaluating investment strategies.

#### Acceptance Criteria

- Historical portfolio values should be stored.
- Users should be able to retrieve previous portfolio performance.
- Growth trends should be displayed using graphical visualizations.
- Historical records should remain available after future portfolio updates.

#### Technical Notes

- Historical portfolio snapshots maintained within the backend.
- Time-series data visualized through interactive charts.
- Portfolio history integrated into dashboard analytics.
...
### US-08: Retrieve Live Market Prices
...
### US-09: Generate an AI Portfolio Summary
...
### US-10: Import Holdings from Investment Statement Images
...
### US-11: Import Portfolio Data from CSV or Excel Files
...
### US-12: Export Portfolio Data as CSV
...
### US-13: Generate Portfolio Reports in PDF Format
...
### US-14: View Relevant Market News
...
### US-15: Calculate Risk Score for Individual Investments
...
### US-16: Evaluate Overall Portfolio Risk
...
### US-17: Generate Personalized Stock Recommendations
...
### US-18: Generate Position-Aware Recommendations
...
### US-19: Identify New Investment Opportunities
...
### US-20: Generate Human-Friendly Investment Explanations
...
### US-21: Deploy Application Using Containerization
...
### US-22: Maintain API Documentation
